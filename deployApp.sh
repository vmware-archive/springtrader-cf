...
cf set-env $frontName JBP_CONFIG_TOMCAT '[tomcat: {version: 6.0.+}]'
...
cf set-env $webName JBP_CONFIG_TOMCAT '[tomcat: {version: 6.0.+}]'
...
cf set-env $backName JBP_CONFIG_TOMCAT '[tomcat: {version: 6.0.+}]'
