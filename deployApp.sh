...
cf push -b java_buildpack -p spring-nanotrader-services/build/libs/spring-nanotrader-services-${version}.war -d ${domain} -n ${frontName} --no-start ${frontName}
...
cf push -b java_buildpack -p spring-nanotrader-services/build/libs/spring-nanotrader-services-${version}.war -d ${domain} -n ${frontName} ${frontName}
...
cf push -b java_buildpack -p spring-nanotrader-web/build/libs/spring-nanotrader-web-${version}.war -d ${domain} -n ${webName} --no-start ${webName}
cf bind-service ${webName} ${frontName}
cf push -b java_buildpack -p  spring-nanotrader-web/build/libs/spring-nanotrader-web-${version}.war -d ${domain} -n ${webName} ${webName}

echo Deploying back end services tier
cf push -b java_buildpack -p spring-nanotrader-asynch-services/build/libs/spring-nanotrader-asynch-services-${version}.war -d ${domain} -n ${backName} --no-start ${backName}
...
cf push -b java_buildpack -p spring-nanotrader-asynch-services/build/libs/spring-nanotrader-asynch-services-${version}.war -d ${domain} -n ${backName} ${backName}
