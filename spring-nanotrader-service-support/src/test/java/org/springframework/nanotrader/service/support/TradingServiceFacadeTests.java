...
public class TradingServiceFacadeTests {
	...
	public void testSynch() {
		...
		org.springframework.nanotrader.service.domain.Quote q = new org.springframework.nanotrader.service.domain.Quote();
		q.setSymbol("GOOG");
		orderRequest.setQuote(q);
		orderRequest.setQuantity(BigDecimal.valueOf(100));
		orderRequest.setPrice(new BigDecimal(345.67));
